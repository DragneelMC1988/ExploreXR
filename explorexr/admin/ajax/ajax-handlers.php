...
function expoxr_save_addon_settings_callback() {
    ...
    if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'expoxr_addon_manager_nonce')) {
    ...
    // Process addon order
    $addon_order = json_decode(stripslashes($_POST['addon_order']), true);
    ...
    $addon_visibility = json_decode(stripslashes($_POST['addon_visibility']), true);
