    ...
    <model-viewer<?php echo wp_kses($attributes_html, 'post'); ?>>
        <?php echo wp_kses_post($annotations_html); ?>
          <?php if (isset($model_attributes['ar'])) : ?>
            ...
            <div class="expoxr-ar-not-supported" style="display: none; position: absolute; bottom: 16px; right: 16px; background: rgba(0,0,0,0.8); color: white; padding: 8px 12px; border-radius: 4px; font-size: 14px; z-index: 10;">
